...
public class ConfigGenerator {
	...
	public static Config generateToyConfig() {
		...
		//ConfigUtils.loadConfig(config, "toyScenarioData/config.xml");
		...
		config.vehicles().setVehiclesFile("toyScenarioData/vehicles.xml");
		config.transit().setVehiclesFile("toyScenarioData/transitVehicles.xml");
		config.plans().setInputFile("toyScenarioData/population.xml");
